package org.apache.seatunnel.plugin.datasource.localfile.analysis;
...
public class LocalFileJobDefinitionAnalyzer extends AbstractJdbcJobDefinitionAnalyzer {

    private static final DbType TYPE = DbType.LOCAL_FILE;
