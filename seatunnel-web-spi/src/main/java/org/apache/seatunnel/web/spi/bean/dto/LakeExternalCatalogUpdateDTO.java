...
/** Non-secret desired-state update for an existing local catalog binding. */
@Data
@JsonIgnoreProperties(ignoreUnknown = true)
public class LakeExternalCatalogUpdateDTO {
    ...
    /** Optimistic version expected by the local CAS primitive. */
    @NotNull
    @Positive
