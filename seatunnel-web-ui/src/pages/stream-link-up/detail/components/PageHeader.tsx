    ...
    <div className="border-b border-[#F2F4F7] bg-white">
      <div className="mx-auto flex max-w-[1540px] items-center justify-between gap-4 px-6 py-5">
        <div className="flex min-w-0 items-center gap-4">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-[#2187A8] bg-[rgba(33,135,168,0.16)] text-[20px] text-[#4DD2FF] shadow-[0_6px_16px_rgba(0,25,34,0.2)]">
            <ProductOutlined />
          </div>
