...
export const DATA_SOURCE_REGISTRY: DataSourceRegistryItem[] = [
  ...
  { dbType: 'KINGBASE', label: 'Kingbase', category: 'RELATIONAL', connectorType: 'Jdbc', pluginName: 'JDBC-KINGBASE', source: true, sink: true, taskSelector: true },
  { dbType: 'DAMENG', label: 'Dameng', category: 'RELATIONAL', connectorType: 'Jdbc', pluginName: 'JDBC-DAMENG', source: true, sink: true, taskSelector: true },
